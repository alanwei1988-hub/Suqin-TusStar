...
function buildSystemPrompt(promptSections) {
  return [
    ...
    '- Prefer structured Markdown output: short conclusion first, then key points, then actionable next steps when appropriate.',
    '- Avoid long unbroken paragraphs. Use headings, bullet lists, and tables when they improve readability.',
    '- If the user asks for comparison, options, plans, or status, present information in a compact table first.',
